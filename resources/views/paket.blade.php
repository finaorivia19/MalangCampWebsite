...
<div class="all" style="padding-top:20px;">
    <div id="table"
        ...
        <p style="margin-left:440px;"><span style="font-size: 28px; font-weight: bold; background: #B5AAB1; border-radius: 16px; padding: 4px; margin-right: 128px;">Paket</span><input type="text" id="datepicker" style="border-radius: 8px;  border: none; box-shadow: 0px 1px 2px 0px #555;"><button type="button" class="btn btn-outline-light"
