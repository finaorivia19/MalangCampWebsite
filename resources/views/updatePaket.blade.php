                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="{{$it->id_item}}"
                                        name="items[]" id="flexCheckChecked" @if (in_array($it->id_item,
                                    $selectedItems)) checked @endif>
            ...
            <div class="card mb-3"
                ...
                <div class="card-body">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 16px;">
                                    <input type="file" name="image_paket" id="image_paket"
                                        class="mb-1 card-title"></input>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="mt-2">
                        ...
                        <button type="submit" class="btn btn-outline-light" style="background-color:#673A54; padding-right: 38px; padding-left: 38px; color: white;">Save</button>
                    </div>
                </div>
            </div>
        </div>
