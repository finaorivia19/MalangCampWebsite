...
<body>
    ...
    <div class="d-flex" style="width: 1050px; height: 35rem; background-color: #96858F; padding: 25px; border-radius: 35px;">

        <table>
            <tr>
                <td>
                    <div class="card" style="border-radius:35px; background-color: #D5D5D5;">
                        <div class="card-body">
                            <iframe
                                    ...
                                    width="450px" height="450px" style="border-radius:20px;" allowfullscreen=""
                ...
                <td></td>
                <td>
                    <div class="card" style="border-radius:35px; background-color: #332C33;">
                        <div class="card-body"
                            style="width: 30rem; height: 30rem; margin-top: 40px; background-color:#000000; border-radius:35px; padding-top:40px; margin:10px;">
                            <ul class="list-group list-group-flush" style="background-color:black; border-radius:35px;">
