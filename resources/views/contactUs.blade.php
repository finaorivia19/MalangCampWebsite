...
<div>
    ...
    -->
<div class="card-all" style="padding-top:10vh;">
    <div class="d-flex" id="table" style=" background-color: #96858F; padding: 3vh; border-radius: 35px; width: 100%;" >
        <div class="card" id="left-box" style="border-radius:35px; background-color: #D5D5D5; margin-right: 16px; width: 50%;">
            <div class="card-body">
                <iframe
                    ...
                    width="100%" height="100%px" style="border-radius:20px;" allowfullscreen="" loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade" id="card-content"></iframe>
            </div>
        </div>

        <div class="card" id="right-box" style="border-radius:35px; background-color: #332C33; width:50%; padding:3vh;">
            <div class="card-body"
                style="width: 100%; height: 100%; background-color:#000000; border-radius:20px; ">
