                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <button type="button" class="btn btn-outline-light"
                                    style="background-color:#AC608D; margin-bottom:-800px; border-radius:20px; width:150px;">Pesan</button>
                                <button type="button" class="btn btn-outline-light"
                                    style="background-color:#673A54; margin-bottom:-800px; border-radius:20px;  width:150px;">Add to
                                    Cart</button>
                            </div>
                        </div>
                    </div>
